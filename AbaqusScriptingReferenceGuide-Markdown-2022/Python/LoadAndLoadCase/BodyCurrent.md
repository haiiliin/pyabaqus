...
The BodyCurrent object is derived from the [Load](https://help.3ds.com/2022/english/DSSIMULIA_Established/SIMACAEKERRefMap/simaker-c-loadpyc.htm?ContextScope=all) object.
...
The optional arguments to setValues are the same as the arguments to the [BodyCurrent ](https://help.3ds.com/2022/english/DSSIMULIA_Established/SIMACAEKERRefMap/simaker-c-bodycurrentpyc.htm?ContextScope=all#simaker-bodycurrentbodycurrentpyc)method, except for the *name* and *createStepName* arguments.
