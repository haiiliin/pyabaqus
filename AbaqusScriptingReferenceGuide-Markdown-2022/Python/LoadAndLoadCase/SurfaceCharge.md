...
The SurfaceCharge object is derived from the [Load](https://help.3ds.com/2022/english/DSSIMULIA_Established/SIMACAEKERRefMap/simaker-c-loadpyc.htm?ContextScope=all) object.
...
The optional arguments to setValues are the same as the arguments to the [SurfaceCharge ](https://help.3ds.com/2022/english/DSSIMULIA_Established/SIMACAEKERRefMap/simaker-c-surfacechargepyc.htm?ContextScope=all#simaker-surfacechargesurfacechargepyc)method, except for the *name* and *createStepName* arguments.
