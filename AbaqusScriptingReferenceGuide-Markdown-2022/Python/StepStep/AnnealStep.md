...
The AnnealStep object is derived from the [AnalysisStep](https://help.3ds.com/2022/english/DSSIMULIA_Established/SIMACAEKERRefMap/simaker-c-analysissteppyc.htm?ContextScope=all) object.
...
The optional arguments to setValues are the same as the arguments to the [AnnealStep ](https://help.3ds.com/2022/english/DSSIMULIA_Established/SIMACAEKERRefMap/simaker-c-annealsteppyc.htm?ContextScope=all#simaker-annealstepannealsteppyc)method, except for the *name*, *previous*, and *maintainAttributes* arguments.
...
- [ANNEAL](https://help.3ds.com/2022/english/DSSIMULIA_Established/SIMACAEKEYRefMap/simakey-r-anneal.htm?ContextScope=all#simakey-r-anneal)
