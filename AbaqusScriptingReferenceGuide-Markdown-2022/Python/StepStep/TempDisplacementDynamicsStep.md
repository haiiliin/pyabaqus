...
The TempDisplacementDynamicsStep object is derived from the [AnalysisStep](https://help.3ds.com/2022/english/DSSIMULIA_Established/SIMACAEKERRefMap/simaker-c-analysissteppyc.htm?ContextScope=all) object.
...
The optional arguments to setValues are the same as the arguments to the [TempDisplacementDynamicsStep ](https://help.3ds.com/2022/english/DSSIMULIA_Established/SIMACAEKERRefMap/simaker-c-tempdisplacementdynamicssteppyc.htm?ContextScope=all#simaker-tempdisplacementdynamicssteptempdisplacementdynamicpyc)method, except for the *name*, *previous*, and *maintainAttributes* arguments.
