...
class BaseAssembly(Feature):
    ...
    @typing.overload
    def Instance(self, name: str, model: Model, autoOffset: Boolean = OFF) -> ModelInstance:
        pass
    ...
    def getFacesAndVerticesOfAttachmentLines(self, edges: EdgeArray):
        ...
        -------
            ...
            *endFace*: A Face object specifying the face associated with the other end of the 
            attachment line. 
            *startVertex*: A Vertex object specifying the vertex associated with one end of the 
            attachment line. This end is also associated with the startFace. 
            *endVertex*: A Vertex object specifying the vertex associated with the other end of the 
