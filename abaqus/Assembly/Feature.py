...
class Feature(BaseFeature):
    ...
    def AttachmentLines(self, name: str, points: int, sourceFaces: tuple[Face], sourceElementFaces: tuple[MeshFace], 
                        ...
                        flipSourceToTargetDirection: Boolean = OFF, setName: str = ''):
    ...
    def Coaxial(self, movableAxis: str, fixedAxis: str, flip: Boolean):
    ...
    def CoincidentPoint(self, movablePoint: str, fixedPoint: str):
    ...
    def EdgeToEdge(self, movableAxis: str, fixedAxis: str, flip: Boolean, clearance: float):
    ...
    def FaceToFace(self, movablePlane: str, fixedPlane: str, flip: Boolean, clearance: float):
    ...
    def ParallelCsys(self, movableCsys: str, fixedCsys: str):
    ...
    def ParallelEdge(self, movableAxis: str, fixedAxis: str, flip: Boolean):
        """This method moves an instance so that its edge is parallel to an edge of a fixed
        instance.
    ...
    def ParallelFace(self, movablePlane: str, fixedPlane: str, flip: Boolean):
