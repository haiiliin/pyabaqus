...
class DamageInitiation:
    ...
    def JohnsonCookDamageInitiation(self, table: tuple, definition: SymbolicConstant = MSFLD, feq: float = 10, fnn: float = 10, 
                                    fnt: float = 10, frequency: int = 1, ks: float = 0, numberImperfections: int = 4, 
                                    temperatureDependency: Boolean = OFF, dependencies: int = 0, alpha: float = 0, 
                                    omega: float = 1, tolerance: float = 0, direction: SymbolicConstant = NMORI):
        """This method creates a DamageInitiation object.
    ...
    def MsfldDamageInitiation(self, table: tuple, definition: SymbolicConstant = MSFLD, feq: float = 10, fnn: float = 10, 
                              fnt: float = 10, frequency: int = 1, ks: float = 0, numberImperfections: int = 4, 
                              temperatureDependency: Boolean = OFF, dependencies: int = 0, alpha: float = 0, 
                              omega: float = 1, tolerance: float = 0, direction: SymbolicConstant = NMORI):
        """This method creates a DamageInitiation object.
    ...
    def QuadeDamageInitiation(self, table: tuple, definition: SymbolicConstant = MSFLD, feq: float = 10, fnn: float = 10, 
                              fnt: float = 10, frequency: int = 1, ks: float = 0, numberImperfections: int = 4, 
                              temperatureDependency: Boolean = OFF, dependencies: int = 0, alpha: float = 0, 
                              omega: float = 1, tolerance: float = 0, direction: SymbolicConstant = NMORI, 
                              position: SymbolicConstant = CENTROID):
    ...
    def QuadsDamageInitiation(self, table: tuple, definition: SymbolicConstant = MSFLD, feq: float = 10, fnn: float = 10, 
                              fnt: float = 10, frequency: int = 1, ks: float = 0, numberImperfections: int = 4, 
                              temperatureDependency: Boolean = OFF, dependencies: int = 0, alpha: float = 0, 
                              omega: float = 1, tolerance: float = 0, direction: SymbolicConstant = NMORI, 
                              position: SymbolicConstant = CENTROID):
    ...
    def MaxpeDamageInitiation(self, table: tuple, definition: SymbolicConstant = MSFLD, feq: float = 10, fnn: float = 10, 
                              fnt: float = 10, frequency: int = 1, ks: float = 0, numberImperfections: int = 4, 
                              temperatureDependency: Boolean = OFF, dependencies: int = 0, alpha: float = 0, 
                              omega: float = 1, tolerance: float = 0, direction: SymbolicConstant = NMORI, 
                              position: SymbolicConstant = CENTROID):
    ...
    def MaxpsDamageInitiation(self, table: tuple, definition: SymbolicConstant = MSFLD, feq: float = 10, fnn: float = 10, 
                              fnt: float = 10, frequency: int = 1, ks: float = 0, numberImperfections: int = 4, 
                              temperatureDependency: Boolean = OFF, dependencies: int = 0, alpha: float = 0, 
                              omega: float = 1, tolerance: float = 0, direction: SymbolicConstant = NMORI, 
                              position: SymbolicConstant = CENTROID):
    ...
    def ShearDamageInitiation(self, table: tuple, definition: SymbolicConstant = MSFLD, feq: float = 10, fnn: float = 10, 
                              fnt: float = 10, frequency: int = 1, ks: float = 0, numberImperfections: int = 4, 
                              temperatureDependency: Boolean = OFF, dependencies: int = 0, alpha: float = 0, 
                              omega: float = 1, tolerance: float = 0, direction: SymbolicConstant = NMORI):
        """This method creates a DamageInitiation object.
    ...
    def HashinDamageInitiation(self, table: tuple, definition: SymbolicConstant = MSFLD, feq: float = 10, fnn: float = 10, 
                               fnt: float = 10, frequency: int = 1, ks: float = 0, numberImperfections: int = 4, 
                               temperatureDependency: Boolean = OFF, dependencies: int = 0, alpha: float = 0, 
                               omega: float = 1, tolerance: float = 0, direction: SymbolicConstant = NMORI):
        """This method creates a DamageInitiation object.
