...
class Part(BasePart):
    ...
    def generateBottomUpExtrudedMesh(self, cell: Cell, numberOfLayers: int, extrudeVector: tuple, geometrySourceSide: str = '', 
    ...
    def generateBottomUpRevolvedMesh(self, cell: Cell, numberOfLayers: int, axisOfRevolution: tuple, angleOfRevolution: float, 
