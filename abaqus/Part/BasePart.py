...
class BasePart(Feature):
    ...
    def PartFromExtrude2DMesh(self, name: str, part: 'BasePart', depth: float, elementSize: float):
    ...
    def PartFromMeshMirror(self, name: str, part: 'BasePart', point1: tuple, point2: tuple):
    ...
    def PartFromSection3DMeshByPlane(self, name: str, part: 'BasePart', point1: float, point2: float, point3: tuple):
    ...
    def Part2DGeomFrom2DMesh(self, name: str, part: 'BasePart', featureAngle: float, splineCurvatureLimit: float = 90,
                             twist: Boolean = OFF):
    ...
    def getAngle(self, plane1: str, plane2: str, line1: str, line2: str, commonVertex: str = ''):
        ...
        line2
            ...
            of them must be specified. 
        commonVertex
            If the two selected Edge objects have more than one vertex in common, this Vertex object 
    ...
    def getDistance(self, entity1: str, entity2: str):
        ...
        ----------
        entity1
            A Vertex, Datum point, MeshNode, or Edge specifying the first entity from which to 
            measure. 
        entity2
            A Vertex, Datum point, MeshNode, or Edge specifying the second entity to which to 
            measure. 
