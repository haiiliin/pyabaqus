...
class Part:
    ...
    def PartFromExtrude2DMesh(self, name: str, part: 'Part', depth: float, elementSize: float):
    ...
    def PartFromMeshMirror(self, name: str, part: 'Part', point1: tuple, point2: tuple):
    ...
    def PartFromSection3DMeshByPlane(self, name: str, part: 'Part', point1: float, point2: float, point3: tuple):
    ...
    def Part2DGeomFrom2DMesh(self, name: str, part: 'Part', featureAngle: float, splineCurvatureLimit: float = 90, 
                             twist: Boolean = OFF):
