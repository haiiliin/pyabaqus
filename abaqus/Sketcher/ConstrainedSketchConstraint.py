...
class ConstrainedSketchConstraint:
    ...
    def FixedConstraint(self, entity: ConstrainedSketchGeometry):
        ...
        ConstrainedSketchGeometry object or a Vertex object and constrains them to be fixed in
        ...
        ----------
        entity
            A ConstrainedSketchGeometry object or a Vertex object specifying the item to fix in 
            space. 
    ...
    def EqualDistanceConstraint(self, entity1: str, entity2: ConstrainedSketchGeometry, midpoint: Vertex):
        ...
        a midpoint Vertex object and any other two Vertex objects or between a midpoint Vertex
        ...
        midpoint
            A Vertex object specifying the vertex that will be positioned an equal distance from 
            *entity1* and *entity2*. 
