...
class ImplicitDynamicsStep(AnalysisStep):
    ...
    def __init__(self, name: str, previous: str, description: str = '', timePeriod: float = 1, 
                 ...
                 initialInc: float = None, minInc: float = None, maxInc: typing.Union[SymbolicConstant, 
                 float] = None, hafTolMethod: SymbolicConstant = VALUE, haftol: float = None, 
                 halfIncScaleFactor: float = None, nohaf: Boolean = OFF, 
                 amplitude: SymbolicConstant = STEP, alpha: typing.Union[SymbolicConstant, 
                 float] = DEFAULT, initialConditions: SymbolicConstant = DEFAULT, 
