...
class OdbDisplay:
    ...
    def ViewCut(self,
                ...
                referenceFrame: SymbolicConstant = FIRST_FRAME) -> ViewCut:
        ...
        -------
            A ViewCut object.
        """
        self.viewCuts[name] = viewCut = ViewCut(name, shape, origin, normal,
                                                axis2, csysName, cylinderAxis,
                                                followDeformation,
                                                overrideAveraging,
                                                referenceFrame)
        return viewCut
