...
class OdbData:
    ...
    *odbData* repository when you import the Visualization module. Abaqus creates a OdbData 
    ...
    # The repository is read-only.
    kinematicCouplings: dict[str,
                             CouplingConstraint] = dict[str,
                                                        CouplingConstraint]()
