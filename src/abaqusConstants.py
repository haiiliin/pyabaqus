...
ADAPTIVE_MESH_SMOOTHING_FAILED = SymbolicConstant(
    'ADAPTIVE_MESH_SMOOTHING_FAILED')
...
ALL_DISTRIB_CONTINUUM_COUPLING = SymbolicConstant(
    'ALL_DISTRIB_CONTINUUM_COUPLING')
ALL_DISTRIB_COUPLING = SymbolicConstant('ALL_DISTRIB_COUPLING')
ALL_DISTRIB_STRUCTURAL_COUPLING = SymbolicConstant(
...
AUGMENTED_LAGRANGE_INCOMPATIBILITIES = SymbolicConstant(
    'AUGMENTED_LAGRANGE_INCOMPATIBILITIES')
...
CAVITY_RADIATION_EMMISIVITY_TOO_LARGE = SymbolicConstant(
    'CAVITY_RADIATION_EMMISIVITY_TOO_LARGE')
CAVITY_RADIATION_PARALLEL_DECOMPOSITION = SymbolicConstant(
    'CAVITY_RADIATION_PARALLEL_DECOMPOSITION')
...
CORRECTION_ACCEPTED_ESTIMATED_CORRECTION = SymbolicConstant(
    'CORRECTION_ACCEPTED_ESTIMATED_CORRECTION')
CORRECTION_ACCEPTED_SMALL_INCREMENT = SymbolicConstant(
    'CORRECTION_ACCEPTED_SMALL_INCREMENT')
...
COUPLED_THERMAL_ELECTRICAL_STRUCTURAL = SymbolicConstant(
...
DENSITY_ROTATIONAL_ACCELERATION = SymbolicConstant(
...
DIRECT_NO_STOP_INCREMENTATION = SymbolicConstant(
...
ELECTROMAGNETIC_TIME_HARMONIC = SymbolicConstant(
    'ELECTROMAGNETIC_TIME_HARMONIC')
ELEMENT = SymbolicConstant('ELEMENT')
ELEMENTS = SymbolicConstant('ELEMENTS')
ELEMENT_ALL = SymbolicConstant('ELEMENT_ALL')
ELEMENT_BY_ELEMENT_INCREMENTATION = SymbolicConstant(
    'ELEMENT_BY_ELEMENT_INCREMENTATION')
...
ELEMENT_FACE_INTEGRATION_POINT = SymbolicConstant(
...
EXTRAPOLATE_COMPUTE_DISCONTINUITIES = SymbolicConstant(
    'EXTRAPOLATE_COMPUTE_DISCONTINUITIES')
...
FREE_TASK_REGION_EQUIV_STRESS = SymbolicConstant(
...
HYSTERESIS_INITIAL_GUESSES_EXHAUSTED = SymbolicConstant(
    'HYSTERESIS_INITIAL_GUESSES_EXHAUSTED')
HYSTERESIS_JACOBIAN_CANNOT_BE_INVERTED = SymbolicConstant(
    'HYSTERESIS_JACOBIAN_CANNOT_BE_INVERTED')
...
INITIAL_OVERCLOSURES_EXPLICIT = SymbolicConstant(
    'INITIAL_OVERCLOSURES_EXPLICIT')
...
JOB_STATUS_COMPLETED_SUCCESSFULLY = SymbolicConstant(
    'JOB_STATUS_COMPLETED_SUCCESSFULLY')
JOB_STATUS_EXITED_WITH_ERROR = SymbolicConstant('JOB_STATUS_EXITED_WITH_ERROR')
JOB_STATUS_TERMINATED_BY_EXTERNAL_REQUEST = SymbolicConstant(
    'JOB_STATUS_TERMINATED_BY_EXTERNAL_REQUEST')
...
LATERAL_EXTENSION_RATIO_NOT_FOUND = SymbolicConstant(
    'LATERAL_EXTENSION_RATIO_NOT_FOUND')
...
MAXIMUM_NUMBER_OF_CONTACT_STRESS_AUGMENTATIONS = SymbolicConstant(
    'MAXIMUM_NUMBER_OF_CONTACT_STRESS_AUGMENTATIONS')
MAXIMUM_NUMBER_OF_EQUILIBRIUM_ITERATIONS = SymbolicConstant(
    'MAXIMUM_NUMBER_OF_EQUILIBRIUM_ITERATIONS')
MAXIMUM_NUMBER_OF_SEVERE_DISCONTINUITY_ITERATIONS = SymbolicConstant(
    'MAXIMUM_NUMBER_OF_SEVERE_DISCONTINUITY_ITERATIONS')
MAXIMUM_SLIDE_DISTANCE_EXCEEDED = SymbolicConstant(
    'MAXIMUM_SLIDE_DISTANCE_EXCEEDED')
...
MODE_BASED_STEADY_STATE_DYNAMIC = SymbolicConstant(
    'MODE_BASED_STEADY_STATE_DYNAMIC')
...
MULTIPLE_DIRECTION_ABSOLUTE_SUM = SymbolicConstant(
    'MULTIPLE_DIRECTION_ABSOLUTE_SUM')
MULTIPLE_DIRECTION_FORTY_PERCENT_RULE = SymbolicConstant(
    'MULTIPLE_DIRECTION_FORTY_PERCENT_RULE')
MULTIPLE_DIRECTION_SRSS_SUM = SymbolicConstant('MULTIPLE_DIRECTION_SRSS_SUM')
MULTIPLE_DIRECTION_THIRTY_PERCENT_RULE = SymbolicConstant(
    'MULTIPLE_DIRECTION_THIRTY_PERCENT_RULE')
...
NORMALIZED_CONCENTRATION_FIELD = SymbolicConstant(
    'NORMALIZED_CONCENTRATION_FIELD')
...
OPT_DATASAVE_FIRST_AND_LAST_CYCLE = SymbolicConstant(
    'OPT_DATASAVE_FIRST_AND_LAST_CYCLE')
OPT_DATASAVE_SPECIFY_CYCLE = SymbolicConstant('OPT_DATASAVE_SPECIFY_CYCLE')
OPT_EXTRACT_SMOOTH_ABAQUS_INPUT_FILE = SymbolicConstant(
...
OUT_OF_PLANE_EXTENSION_RATIO_NOT_FOUND = SymbolicConstant(
    'OUT_OF_PLANE_EXTENSION_RATIO_NOT_FOUND')
...
PENETRATION_TOLERANCE_EXCEEDED = SymbolicConstant(
    'PENETRATION_TOLERANCE_EXCEEDED')
...
PIEZO_ELECTRICAL_POTENTIAL_FIELD = SymbolicConstant(
    'PIEZO_ELECTRICAL_POTENTIAL_FIELD')
...
RESTRICTED_TASK_REGION_EQUIV_STRESS = SymbolicConstant(
...
SOFT_CONTACT_INCOMPATIBILITIES = SymbolicConstant(
    'SOFT_CONTACT_INCOMPATIBILITIES')
SOILS = SymbolicConstant('SOILS')
SOLID = SymbolicConstant('SOLID')
SOLIDWORKS = SymbolicConstant('SOLIDWORKS')
SOLUTION_APPEARS_TO_BE_DIVERGING = SymbolicConstant(
    'SOLUTION_APPEARS_TO_BE_DIVERGING')
...
SUBSPACE_STEADY_STATE_DYNAMIC = SymbolicConstant(
    'SUBSPACE_STEADY_STATE_DYNAMIC')
...
TEMPERATURE_FALLEN_BELOW_ABSOLUTE_ZERO = SymbolicConstant(
    'TEMPERATURE_FALLEN_BELOW_ABSOLUTE_ZERO')
...
TIME_INTEGRATION_ACCURACY_LIMIT_EXCEEDED = SymbolicConstant(
    'TIME_INTEGRATION_ACCURACY_LIMIT_EXCEEDED')
TIME_INTEGRATION_STABILITY_LIMIT_EXCEEDED = SymbolicConstant(
    'TIME_INTEGRATION_STABILITY_LIMIT_EXCEEDED')
...
TRANSVERSE_SHEAR_FORCE_CONSTRAINT = SymbolicConstant(
    'TRANSVERSE_SHEAR_FORCE_CONSTRAINT')
...
UNCONVERGED_CONCRETE_PLASTICITY = SymbolicConstant(
    'UNCONVERGED_CONCRETE_PLASTICITY')
UNCONVERGED_CREEP_PLASTICITY = SymbolicConstant('UNCONVERGED_CREEP_PLASTICITY')
UNCONVERGED_DRUCKER_PRAGER_PLASTICITY = SymbolicConstant(
    'UNCONVERGED_DRUCKER_PRAGER_PLASTICITY')
...
UNCONVERGED_MOHR_COULOMB_PLASTICITY = SymbolicConstant(
    'UNCONVERGED_MOHR_COULOMB_PLASTICITY')
...
UNRESOLVED_INITIAL_OVERCLOSURES = SymbolicConstant(
    'UNRESOLVED_INITIAL_OVERCLOSURES')
...
VAN_DER_WALLS_STRETCHES_LOCKING = SymbolicConstant(
    'VAN_DER_WALLS_STRETCHES_LOCKING')
