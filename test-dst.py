...
# STEP
mdb.models['Model-1'].StaticStep(name='INITIAL-STRESS', previous='Initial', maxNumInc=100, initialInc=0.001, minInc=1e-5,
                                 maxInc=1, matrixSolver=DIRECT, matrixStorage=UNSYMMETRIC)
mdb.models['Model-1'].StaticStep(name='SHEAR', previous='INITIAL-STRESS', maxNumInc=100, initialInc=0.001, minInc=1e-5,
                                 maxInc=1, matrixSolver=DIRECT, matrixStorage=UNSYMMETRIC)
