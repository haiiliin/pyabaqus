...
os.chdir(r'C:\Users\user\OneDrive\Documents\GitHub\PyAbaqusBase\tests\dst')
...
# STEP
mdb.models['Model-1'].StaticStep(name='INITIAL-STRESS', previous='Initial', maxNumInc=100, initialInc=1, minInc=1e-5,
                                 maxInc=1, matrixSolver=DIRECT, matrixStorage=UNSYMMETRIC)
mdb.models['Model-1'].StaticStep(name='SHEAR', previous='INITIAL-STRESS', maxNumInc=100, initialInc=1, minInc=1e-5,
                                 maxInc=1, matrixSolver=DIRECT, matrixStorage=UNSYMMETRIC)
...
mdb.models['Model-1'].FieldOutputRequest(
    name='F-Output-1', createStepName='SHEAR', frequency=50,
